...
namespace TSF.AlmaStyleFix
{
    ...
    public class ToolsOptions : DialogPage
    {
        ...
        /// <summary>
        /// Campo privato che indica se usare l'ordinatore
        /// </summary>
        private bool useNarrange = true;
        ...
        /// <summary>
        /// Recupera o imposta un valore che indica se usare l'ordinatore delle classi.
        /// </summary>
        public bool UseNarrange
        {
            get { return this.useNarrange; }
            set { this.useNarrange = value; }
        }
